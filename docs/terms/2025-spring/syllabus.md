...
# COMP 4200 Formal Languages <br> Spring 2025 Course Syllabus
...
Week | Topic(s)            
-----| -----------          
1  | Introduction, proofs, **hw 1**
2  | Strings and sets 
3  | Finite automata and regular sets, **hw 2** 
4  | Nondeterministic finite automata and conversion to DFA, **hw 3** 
5  | Pattern matching, regular expressions & relation to finite automata 
6  | Limits of finite automata **hw 4** 
7  | Pumping lemma, **midterm 1**    
8  | Context free grammars and languages
9  | Chomsky Normal Form, Pushdown automata, Parsing, **hw 5** 
10 | Pushdown automata and relation to context-free grammars, **hw6**  
11 | Turing machines and effective computability, **midterm 2**
12 | Universal machines and decidability, **hw 7** 
13 | Diagonalization
14 | Implementing a Turing machine simulator
15 | Catch-up, review, **midterm 3**
 
**Final Exam**: **Tuesday, May 6, 1:30 PM - 3:30 PM** (follows the Registrar's final exam schedule)
